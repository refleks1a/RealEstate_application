...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=gettext_lazy("Phone numnber"),
    ...
    licence = models.CharField(max_length=31, verbose_name=gettext_lazy("Real Estate licence"),
    ...
    is_buyer = models.BooleanField(verbose_name=gettext_lazy("Buyer"), default=False,
                                help_text=gettext_lazy("Are you looking to buy a ptoperty?"))
